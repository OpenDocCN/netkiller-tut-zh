...
sockstat | grep rsync
root     rsync      60491 3  dgram  -> /var/run/logpriv
root     rsync      60491 4  tcp6   *:873                 *:*
root     rsync      60491 5  tcp4   *:873                 *:*
...
```
 ┌────────────────────────────────────────────────────────────────────┐
 │                    Options for ntop 3.3.10_5                       │
 │ ┌────────────────────────────────────────────────────────────────┐ │
 │ │         [ ] LOCALE      Enable locale (i18n) support.          │ │
 │ │         [X] PCAP_PORT   Use libpcap from ports.                │ │
 │ │         [X] XMLDUMP     Enable XML Dump support.               │ │
