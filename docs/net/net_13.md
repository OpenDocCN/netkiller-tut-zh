# 部分 IX. Banggoo - ADC 3000 (应用交付控制器)
...
| ![](img/Services-Traffic-IP-Groups.png) |
...
| ![](img/Pools-Create-a-new-Pool.png) |
...
| ![](img/Services-Create-a-new-Virtual-Server.png) |

Your configuration has been updated.

| ![](img/Virtual-Server-Basic-Settings-Listening-on.png) |

### Status

| ![](img/Status-Virtual-Server.png) |

| ![](img/Status-Start-Virtual-Server.png) |
